...
<table id="example2" class="table table-bordered table-hover">
    ...
    @click="deleteAdmin(product,index)"
    ...
    <div v-else>
    <button class="btn btn-primary" @click="restoreAdmin(product,key)" > Restore </button>
    <button class="btn btn-danger" @click="deleteforeverAdmin(product,key)"> Delete for ever </button>
